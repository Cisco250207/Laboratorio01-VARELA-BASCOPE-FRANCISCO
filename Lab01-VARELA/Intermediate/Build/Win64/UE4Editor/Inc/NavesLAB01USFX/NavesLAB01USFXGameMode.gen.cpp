...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ANavesLAB01USFXGameMode_Statics::Class_MetaDataParams[] = {
		{ "Comment", "// GameMode del juego que hereda de AGameModeBase de Unreal, es el que controla todo como: spawna las naves, maneja los timers y decide cu\xc3\xa1ndo formar o romper la posici\xc3\xb3n\n" },
		{ "HideCategories", "Info Rendering MovementReplication Replication Actor Input Movement Collision Rendering Utilities|Transformation" },
		{ "IncludePath", "NavesLAB01USFXGameMode.h" },
		{ "ModuleRelativePath", "NavesLAB01USFXGameMode.h" },
		{ "ShowCategories", "Input|MouseInput Input|TouchInput" },
		{ "ToolTip", "GameMode del juego que hereda de AGameModeBase de Unreal, es el que controla todo como: spawna las naves, maneja los timers y decide cu\xc3\xa1ndo formar o romper la posici\xc3\xb3n" },
	};
#endif
	...
	IMPLEMENT_CLASS(ANavesLAB01USFXGameMode, 198574027);
