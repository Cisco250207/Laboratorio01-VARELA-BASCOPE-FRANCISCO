...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemigo_Statics::NewProp_CentroFormacion_MetaData[] = {
		{ "Category", "Formacion" },
		{ "Comment", "// N\xc3\xbamero del 0 al 9 que dice qu\xc3\xa9 parte que le toca a este enemigo\n" },
		{ "ModuleRelativePath", "Enemigo.h" },
		{ "ToolTip", "N\xc3\xbamero del 0 al 9 que dice qu\xc3\xa9 parte que le toca a este enemigo" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemigo_Statics::NewProp_bEnFormacion_MetaData[] = {
		{ "Category", "Formacion" },
		{ "Comment", "// Punto central, los offsets se calculan desde aqu\xc3\xad\n" },
		{ "ModuleRelativePath", "Enemigo.h" },
		{ "ToolTip", "Punto central, los offsets se calculan desde aqu\xc3\xad" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AEnemigo_Statics::NewProp_EscalaFormacion_MetaData[] = {
		{ "Category", "Formacion" },
		{ "Comment", "// true = va a su posici\xc3\xb3n, false = vaga libre por el nivel\n" },
		{ "ModuleRelativePath", "Enemigo.h" },
		{ "ToolTip", "true = va a su posici\xc3\xb3n, false = vaga libre por el nivel" },
	};
#endif
	...
	IMPLEMENT_CLASS(AEnemigo, 4147389027);
